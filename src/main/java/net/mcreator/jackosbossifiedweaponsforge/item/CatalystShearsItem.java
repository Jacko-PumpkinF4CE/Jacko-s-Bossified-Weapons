...
import net.mcreator.jackosbossifiedweaponsforge.procedures.CatalystShearsLivingEntityIsHitWithToolProcedure;

import java.util.List;

public class CatalystShearsItem extends SwordItem {
	public CatalystShearsItem() {
		super(new Tier() {
			public int getUses() {
				return 1190;
			}
	...
	public boolean hurtEnemy(ItemStack itemstack, LivingEntity entity, LivingEntity sourceentity) {
		...
		CatalystShearsLivingEntityIsHitWithToolProcedure.execute(entity.level(), entity, sourceentity);
		return retval;
	}
