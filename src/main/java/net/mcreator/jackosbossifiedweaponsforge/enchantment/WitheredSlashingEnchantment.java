...
public class WitheredSlashingEnchantment extends Enchantment {
	public WitheredSlashingEnchantment(EquipmentSlot... slots) {
		super(Enchantment.Rarity.RARE, EnchantmentCategory.WEAPON, slots);
	}

	@Override
	protected boolean checkCompatibility(Enchantment ench) {
		return this != ench && !List.of(JackosBossifiedWeaponsForgeModEnchantments.SKULL_SHOT.get(), JackosBossifiedWeaponsForgeModEnchantments.WITHERING_POTENCY.get()).contains(ench);
	}
