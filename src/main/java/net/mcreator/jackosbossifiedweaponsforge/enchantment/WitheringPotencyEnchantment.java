...
public class WitheringPotencyEnchantment extends Enchantment {
	public WitheringPotencyEnchantment(EquipmentSlot... slots) {
		super(Enchantment.Rarity.RARE, EnchantmentCategory.WEAPON, slots);
	}

	@Override
	protected boolean checkCompatibility(Enchantment ench) {
		return this != ench && !List.of(JackosBossifiedWeaponsForgeModEnchantments.SKULL_SHOT.get(), JackosBossifiedWeaponsForgeModEnchantments.WITHERED_SLASHING.get()).contains(ench);
	}
